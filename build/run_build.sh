...
# -sys: 
# -config_l1i_size=4096 : set l1 instruction cache to 4k (instead of default 16k) [build]
#--------------------------------------------
sim="ifu_esl_counter"
...
#sims -sys=manycore -x_tiles=3 -y_tiles=3 -msm_build -clean -build_id=tiles_3x3_msm
#sims -sys=manycore -x_tiles=1 -y_tiles=1 -msm_build -clean -build_id=tiles_1x1_msm_ariane -ariane
sims -sys=manycore -x_tiles=3 -y_tiles=3 -msm_build -clean -build_id=tiles_3x3_msm_ariane -ariane
