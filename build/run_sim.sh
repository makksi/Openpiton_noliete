...
# -sim_run_args=+vcd: to generate vcd output for icarus verilog 
# -sim_run_args=-debugdb: to generate .dmg files needed for schematic view in modelsim
#--------------------------------------------
...
#MODELSIM
sims -sys=manycore -x_tiles=3 -y_tiles=3 -msm_run -gui -log_all hello_world.c -build_id=tiles_3x3_msm_ariane -sim_run_args=-debugdb -ariane 
#sims -sys=manycore -x_tiles=1 -y_tiles=1 -msm_run -gui -log_all hello_world.c -build_id=tiles_1x1_msm_ariane -sim_run_args=-debugdb -ariane 
...
#sims -sys=manycore -x_tiles=3 -y_tiles=3 -msm_run -gui -log_all uart-hello-world.s -build_id=tiles_3x3_msm
